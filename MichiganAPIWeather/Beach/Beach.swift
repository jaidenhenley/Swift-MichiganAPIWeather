...
struct Beach: Identifiable {
    ...
    static let allBeaches: [Beach] = [
        ...
        Beach(
            ...
            keywords: ["lake michigan", "northwest michigan", "petoskey stones", "rock hunting", "swimming", "hiking", "camping", "family", "scenic", "quiet", "restrooms"],
            displayKeywords: [
                DisplayKeyword(icon: "water.waves", label: "Lake Michigan"),
                DisplayKeyword(icon: "tree", label: "State Park"),
        ...
        Beach(
            ...
            displayKeywords: [
                DisplayKeyword(icon: "water.waves", label: "Lake Superior"),
                DisplayKeyword(icon: "tree", label: "City Park"),
